		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="adicionado comece">
					...
					<span class="text">
						Atenção dono de delivery e lojista. Ao se cadastrar você ganha <br/> <strong><?php echo data_info( "planos",$plano_default,"duracao_dias" ); ?> dias</strong> <br/>para testar nossa plataforma, criar seu cardápio digital ou sua loja web de catálogo e impulsionar suas vendas.
					</span>
