<nav class="navbar pull-left">
	<ul class="nav navbar-nav">
		...
		<li class="active"><a href="https://api.whatsapp.com/send?text=Aderi a *1 click pedidos* para ter uma loja virtual para minha empresa integrado com o WhatsApp, cadastre-se vc tb e teste por 30 dias sem compromisso com todas as funções liberadas, venha conhecer essa ferramenta maravilhosa. Eu estou gostando muito, *clique no link:* https://1clickpedidos.app.br/comece/">Indique 1 amigo</a></li>
		<!--
