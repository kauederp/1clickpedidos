...
$sql2 = mysqli_query( $db_con, "SELECT token FROM impressao WHERE ide = '$eid'" );
$total_results2 = mysqli_fetch_array( $sql2 );
 	            ...
 	            <div class="row">
	              ...
	              <div class="col-md-12">
		              ...
		              <div class="form-field-default">
						  ...
						  1 - Solicite o arquivo de instalação do sistema com o suporte técnico da 1 click pedidos.<br/>
						  ...
						  3 - Após isso execute o sistema como administrador.
						   <label>Meu token <?php echo $total_results2[0];  ?></label>
...
<div class="row">
			...
			<div class="row">
	            ...
	            <div class="col-md-3">
	            	<label></label>
					<a href="https://wa.me/5585987816788" target="_blank">
	              	 <button>
	              		<span>
