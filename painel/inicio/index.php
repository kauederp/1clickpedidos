...
<?php modal_alerta("Seu plano encontrasse expirado, contrate um novo plano para continuar a usar os serviços!","erro"); ?>

<?php } ?>

<?php if( $_GET['msg'] == "funcaodesativada" ) { ?>

<?php modal_alerta("Seu plano não tem acesso a essa funcionalidade, contrate um plano clicando em Meu Plano!","erro"); ?>

<?php } ?>

<?php if( $_GET['msg'] == "bem-vindo" ) { ?>

<?php modal_alerta("Sua plataforma foi criada com sucesso. Aproveite o seu período de testes!<br/><br/>Ao final do período você deve escolher um plano para continuar utilizando o sistema.","sucesso"); ?>
					...
					<div class="col-md-4">
						<div class="lista-menus-menu lista-menus-nocounter">
							<a class="bt" href="#">
								...
								<span>Pedidos em <?php print date("Y");?><br/><?php print $datapedidos; ?></span>
								<div class="clear"></div>
							</a>
						</div>
					</div>
					...
					<div class="col-md-4">
						<div class="lista-menus-menu">
							<a class="bt" href="<?php panel_url(); ?>/produtos">
								...
								<span>Produtos e variações</span>
