								...
								<td>
                                    ...
                                    <div class="fake-table-data">
										<div class="form-actions pull-right">
										    ...
										    <a class="color-green" style="font-weight: bold;" href="<?php panel_url(); ?>/produtos/desativar/?id=<?php echo $data['id']; ?>" title="Desativar"><!-- <i class="lni lni-cross-circle"></i> -->ON </a>
										    <?php } ?>
										    
										    <?php if($data['status'] == 2 ) { ?>
										    <a class="color-red" style="font-weight: bold;" href="<?php panel_url(); ?>/produtos/ativar/?id=<?php echo $data['id']; ?>" title="Ativar"><!-- <i class="lni lni-checkmark-circle"></i> -->OFF</a>
										    <?php } ?>
