                                                        ...
                                                        <div class='item'>
                                                          <div class='title'>
                                                            ...
                                                            <div class="esconder text-primary text-<?php echo (htmljson($variacao[$x]['item'][$y]['esconder']) == 'false' ? 'danger' : 'primary'); ?>  esconder-item">
                                                                  ...
                                                                  <span><?php echo (htmljson($variacao[$x]['item'][$y]['esconder'])); ?></span>
                                                                </div>
                                                            </div>
    ...
    document.querySelectorAll(".lni.lni-eye").forEach(e => {
      ...
      e.onclick = () => {
        e.parentElement.parentElement.classList.toggle("text-danger")
          ...
          e.parentElement.parentElement.children[1].value = !e.parentElement.parentElement.classList.contains("text-danger")
          let span =  e.parentElement.parentElement.children[2]
          
          if(e.parentElement.parentElement.children[1].value == "true"){
