...
function new_agendamento( $estabelecimento,$sun,$mon,$tue,$wed,$thu,$fri,$sat,$hora,$acao ) {
	...
	if( mysqli_query( $db_con, "INSERT INTO agendamentos (rel_estabelecimentos_id,sun,mon,tue,wed,thu,fri,sat,hora,acao) VALUES ('$estabelecimento','$sun','$mon','$tue','$wed','$thu','$fri','$sat','$hora','$acao');") ) {
