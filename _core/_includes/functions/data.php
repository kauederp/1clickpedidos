<?php
	...
	function welcome_mail($email,$pass) {
		...
		if( html_mail( $email,"Bem vindo ao CodigoPower!",$msg ) ) {
...
// cadastro simplificado
	...
	function new_produto( $estabelecimento,$categoria,$destaque,$estoque,$posicao,$ref,$nome,$video_link,$descricao,$valor,$oferta,$valor_promocional,$variacao,$status,$visible,$integrado ) {
		...
		if( mysqli_query( $db_con, "INSERT INTO produtos (rel_estabelecimentos_id,rel_categorias_id,destaque,estoque,posicao,ref,nome,video_link,descricao,valor,oferta,valor_promocional,variacao,status,visible,created,last_modified,integrado) VALUES ('$estabelecimento','$categoria','$destaque','$estoque','$posicao','$ref','$nome','$video_link','$descricao','$valor','$oferta','$valor_promocional','$variacao','$status','$visible','$datetime','$datetime','$integrado');") ) {
	...
	function edit_produto( $id,$estabelecimento,$categoria,$destaque,$estoque,$posicao,$ref,$nome,$video_link,$descricao,$valor,$oferta,$valor_promocional,$variacao,$status,$visible,$integrado ) {
		...
		$updatedquery = "UPDATE produtos SET rel_estabelecimentos_id = '$estabelecimento',rel_categorias_id = '$categoria',ref = '$ref',nome = '$nome',video_link = '$video_link',estoque = '$estoque',posicao = '$posicao',descricao = '$descricao',valor = '$valor',oferta = '$oferta',valor_promocional = '$valor_promocional',variacao = '$variacao',status = '$status',visible = '$visible',last_modified = '$datetime',integrado = '$integrado' WHERE id = '$id'";
...
// BANNERS MARKETPLACE
	...
	function new_banner_marketplace( $titulo,$desktop,$mobile,$link,$status ) {
		...
		if( mysqli_query( $db_con, "INSERT INTO banners_marketplace (rel_estabelecimentos_id,titulo,desktop,mobile,link,status,created,last_modified) VALUES ('1','$titulo','$desktop','$mobile','$link','$status','$datetime','$datetime');") ) {
	...
	function edit_banner_marketplace( $id,$estabelecimento,$titulo,$desktop,$mobile,$link,$status ) {
		...
		$updatedquery = "UPDATE banners_marketplace SET titulo = '$titulo',desktop = '$desktop',mobile = '$mobile',link = '$link',status = '$status' WHERE id = '$id'";
