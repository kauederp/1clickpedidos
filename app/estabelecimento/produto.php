												...
												<div class="row">	
													<div class="col-md-12">
														...
														<div class="opcoes">
															...
															<div class="opcao <?php if( variacao_opcao_ativa( $data_content['id'],$x,$y ) ) { echo 'active'; }; echo 'ok '.base64_decode($variacao[$x]['item'][$y]['esconder'])=='false'?'d-none':'';?>" variacao-item="<?php echo $y; ?>" nomeda-variacao="<?php echo htmljson( $variacao[$x]['nome'] ) ;?>" valor-adicional="<?php echo htmljson( $variacao[$x]['item'][$y]['valor'] ); ?>">
