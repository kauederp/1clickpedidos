							...
							<div class="linha-subtotal">
								...
								<div class="row">
									...
									<input class="fake-hidden" name="pedido_minimo" value=""/>
										...
										<button class="botao-acao"><i class="lni lni-bi-cycle"></i> <span>Entrega</span></button>
...
$(document).ready( function() {
  ...
  form.validate({
      ...
      messages:{
        pedido_minimo: {
            required: "Você deve ter no minimo <?php echo $app['pedido_minimo']; ?> na sacola para poder efetuar a compra"
        },
      }
  });
