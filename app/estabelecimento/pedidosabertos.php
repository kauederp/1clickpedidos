				...
				<div class="container nopaddmobile">
					...
					<div class="obrigado">
						...
						<?php
							...
							$query = "SELECT * FROM pedidos WHERE NOT (forma_pagamento = 7 AND status = 1) AND whatsapp = '".$_COOKIE['celcli']."' AND rel_estabelecimentos_id = '$app_id' AND (status = '1' OR status = '4' OR status = '5' OR status = '6' OR status = '7' OR status = '8') ORDER BY id DESC";
