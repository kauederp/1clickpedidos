			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="mini-links pull-right">
						<a target="_blank" href="https://<?php echo $simple_url; ?>"><i class="lni lni-heart"></i> Conheça</a>
						<a target="_blank" href="https://api.whatsapp.com/send?phone=5585987816788&text=Olá, preciso de ajuda!"><i class="lni lni-headphone-alt"></i> Fale conosco</a>
